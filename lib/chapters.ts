...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    sections: ["Problem 1: Number of Islands (Graph Traversal)", "Problem 2: Course Schedule (Topological Sorting)", "Problem 3: Word Ladder (Shortest Path)", "Problem 4: Number of Connected Components (Union-Find)", "Problem 5: Clone Graph (Advanced Traversal)"],
  },

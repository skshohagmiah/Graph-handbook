    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="container mx-auto px-6 py-16">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-1 mb-4">
                    {chapter.sections.slice(0, 2).map((section) => (
                      <div key={section} className="text-xs text-muted-foreground flex items-center gap-2">
                    ...
                    {chapter.sections.length > 2 && (
                      <div className="text-xs text-muted-foreground flex items-center gap-2">
                        ...
                        <span>+{chapter.sections.length - 2} more sections</span>
                      </div>
                    )}
                  </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Master the essential algorithms that solve real-world problems: traversal, shortest paths, spanning trees, and topological sorting.
          </p>
        </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 gap-2 mb-6">
                    {chapter.sections.map((section) => (
                      <div key={section} className="text-sm text-muted-foreground flex items-center gap-3 py-1">
